...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between gap-2 rounded-xl border border-white/10 bg-white/5',
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        'bg-govbg-surface shadow-glass text-slate-100',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref} className={cn('px-3 py-1.5 text-xs font-semibold text-slate-500', className)} {...props} />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'outline-none focus:bg-teal-600/20 focus:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
